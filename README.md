...
> **🚀 Help Needed: Google Play Closed Testing**
>
> To release Fidely on Google Play Store, I need testers! [Join the closed testing program](docs/CLOSED_TESTING.md) and be among the first to test the Android version.
