...
class LightTheme {
  static final Color primaryColor = const Color.fromARGB(255, 36, 123, 194);
  static final Color secondaryColor = Color.fromARGB(255, 255, 173, 51);

  static final Color backgroundColor = Colors.white;
  static final Color onBackgroundColor = Colors.grey.shade200;
  static final Color surfaceColor = Colors.white;
  static final Color onSurfaceColor = Colors.black87;
